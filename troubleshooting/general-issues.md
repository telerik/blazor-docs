...
The error is a general Blazor WebAssembly issue, which can result from the build process, publishing process, or browser cache. In [our knowledge base article about this exception]({%slug common-kb-failed-to-find%}) you can find online discussions and documentation on the matter, which suggest possible solutions.
