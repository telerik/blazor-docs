...
Telerik Blazor CDN distributes the most commonly used swatches of each base theme. Here you can find a list of their CDN URLs - [Telerik Blazor CDN]({%slug swatch-distribution%}#telerik-blazor-cdn).
