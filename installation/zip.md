...
* The [built-in themes]({%slug general-information/themes%}) and some of their most commonly used [swatches]({%slug theme-swatches%}). You can find them in the `styles` folder in the archive.
