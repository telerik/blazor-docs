...
Choose whether to load the required Telerik UI stylesheet and JS Interop file as [static NuGet assets]({%slug getting-started/what-you-need%}#css-theme-and-javascript-files) or [load them from CDN]({%slug common-features-cdn%}).
