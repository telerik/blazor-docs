...
> Telerik REPL for Blazor now includes a Preview of the AI-powered [Agentic UI Generator](slug:agentic-ui-generator-getting-started) development tool to help you create pages and UI for Blazor components through natural language. Simply describe your UI requirements, and the Generator will produce code that follows component best practices, uses realistic sample data, and applies [Progress Design System](https://www.telerik.com/design-system/docs/) styling.
