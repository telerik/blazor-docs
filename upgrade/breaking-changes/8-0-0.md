...
Telerik UI for Blazor 8.0.0 [depends on a new `Telerik.Licensing` NuGet package](slug:getting-started-workflow-details#nuget-packages). This change may be relevant to environments that:
