...
To use built-in Telerik icons, [register the new icon namespaces](slug:common-features-icons#how-blazor-icons-work) - `Telerik.FontIcons` or `Telerik.SvgIcons`.
...
* [TreeList popup edit form `ButtonsLayout`](slug:treelist-editing-popup#customization)
