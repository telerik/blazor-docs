...
All [applicable components](slug:breaking-changes-in-13-0-0#components-that-use-appearance-parameters) render CSS classes for the following parameters only if these parameters are set explicitly:
