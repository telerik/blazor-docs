...
To continue using `FontIcons` as the default icon type in the application, [set the global icon type to `Font`](slug:common-features-icons#set-global-blazor-icon-type).
