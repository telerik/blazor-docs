...
By default, the filtering will be debounced with 150ms. You can configure that through the [`DebounceDelay`]({%slug autocomplete-overview%}#parameters) parameter of the component.
