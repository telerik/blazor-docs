...
1. [Bind the value of the component](slug:common-features-data-binding-overview#data-binding-vs-value-binding) to the same type as the member of the `ValueField` parameter.
