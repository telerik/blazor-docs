...
description: Discover the Telerik Popup component for Blazor. Learn how to add the component to your app and explore its features like positioning, alignment, alignment, and animation customization.
slug: popup-overview
