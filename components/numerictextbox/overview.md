...
The Numeric TextBox has a `FocusAsync` method that enables programmatic focus. To use it, obtain a reference to the component instance via `@ref`. @[template](/_contentTemplates/common/inputs.md#focus-kb)
