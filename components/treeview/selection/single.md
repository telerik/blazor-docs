...
In this article:
* [Basics](#basics)
 * [Example - Handle SelectedItemsChanged event](#example---handle-selecteditemschanged-event)
...
### Example - Handle SelectedItemsChanged event
...
![selection single example](../images/selection-single-example.png)
