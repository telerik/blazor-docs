...
In this article:
* [Basics](#basics)
 * [Example - Select nodes from different models](#example---select-nodes-from-different-models)
...
### Example - Select nodes from different models
...
![selection multiple example](../images/selection-multiple-example.png)
