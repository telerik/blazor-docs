...
## Comparison with ExpansionPanel

The [ExpansionPanel](slug:expansionpanel-overview) and PanelBar are similar and interchangeable in some aspects. The major differences between the two components are:
...
<demo metaUrl="client/panelbar/overview/" height="420"></demo>
