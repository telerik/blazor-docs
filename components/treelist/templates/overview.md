...
Like other Blazor content, most of them can receive a `context` argument that is the type of the model. To use templates, you must treelist the grid to a named model. The header templates are the exception as they are not related to rows and models.
