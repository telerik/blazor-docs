...
With the `FormTemplate` feature, you can customize the appearance and content of the create/edit Popup window of the TreeList. To set it, provide contents to the `<FormTemplate>` inner tag of the `<TreeListPopupEditFormSettings>`.
