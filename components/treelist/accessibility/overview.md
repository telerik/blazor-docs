...
The following example demonstrates the [accessibility compliance of the TreeList component]({%slug grid-wai-aria-support%}). The described level of compliance is achievable with the [Ocean Blue A11y Accessibility Swatch]({%slug themes-accessibility-swatch%}).
