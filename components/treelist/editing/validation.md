...
Install the [`Blazilla` NuGet package](https://www.nuget.org/packages/Blazilla) to run the following code and refer to the [FluentValidation documentation](https://docs.fluentvalidation.net/en/latest/built-in-validators.html).
...
<TelerikTreeList Data="@TreeListData"
    ...
    <TreeListSettings>
        <TreeListValidationSettings Enabled="@TreeListValidationEnabled">
            <ValidatorTemplate>
                <FluentValidator Validator="@TreeListFluentValidator" />
            </ValidatorTemplate>
