...
You can export the grid to CSV with a click of a button. The current filter, sort, page, grouping, column order and column size are applied to the `.csv` document.
