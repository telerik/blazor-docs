...
* Some PDF fonts do not have Cyrillic (or other alphabets) characters. In such cases, one must [load the fonts explicitly](https://docs.telerik.com/devtools/document-processing/knowledge-base/pdfprocessing-implement-fontsprovider).
