...
>caption In this article the information will be separate in the following sections:

* [Data Binding](#data-binding)

* [Loading Animation](#loading-animation)

* [Blazor Grid Reference](#blazor-grid-reference)

* [Blazor Grid Feature](#blazor-grid-features)

    * [Autogenerated Columns](#autogenerated-columns)
    * [Editing](#editing)
    * [Paging](#paging)
    * [Sorting](#sorting)
    * [Filtering](#filtering)
...
* [Styling](#styling)
    ...
    * [Elastic Design](#elastic-design)

* [Additional Resources](#additional-resources)
    
    * [Additional Grid Examples](#additional-grid-examples)
...
You can find additional examples on how to implement different scenarios with the Grid in our [public GitHub repository](https://github.com/telerik/blazor-ui/tree/master/grid).

### Knowledge Base articles

* [Aggregates for TelerikGrid with DataTable Binding]({%slug grid-kb-aggregates-and-datatable%})

* [Align Columns in Hierarchical Grid]({%slug grid-kb-align-columns-hierarchy%})

* [Bind to navigation properties in complex objects]({%slug grid-use-navigation-properties%})

* [Grid is too wide under bootstrap column, or causes unexpected scrollbars in the layout]({%slug grid-kb-flex-width-issue%})

* [Cascading DropDownList in Grid Editing]({%slug grid-kb-cascade-dropdowns-for-fields%})

* [Dynamically control column attributes during update or create. (Editable = true/false)]({%slug grid-change-editable-attribute-update-create%})

* [Prevent clicking in the Grid Header Template from triggering sorting]({%slug grid-kb-click-header-template-sorts%})

* [Debounce grid data source operations]({%slug grid-kb-debounce-operations%})

* [Setting default values in new row]({%slug grid-kb-default-value-for-new-row%})

* [Nested Grid - Unexpected (Multiple) calls to OnParametersSetAsync]({%slug grid-kb-detailtemplate-renders%})

* [Dynamic Templates that can be repeated easily]({%slug grid-kb-dynamic-columns-templates%})

* [Hierarchy Editing]({%slug grid-kb-editing-in-hierarchy%})

* [Edit the Selected Item From the ToolBar]({%slug grid-edit-selected-item%})
...
* [Get the Index Of a Grid Row]({%slug grid-kb-index-of-a-grid-row%})

* [Consume gRPC services in Blazor]({%slug common-kb-grpc%})

* [Only one filter option in FilterMenu]({%slug grid-kb-only-one-filtermenu-option%})

* [GridColumn does not have a property ChildContent]({%slug grid-kb-no-childcontent%})

* [Prevent the Grid from wrapping text in multiple lines]({%slug grid-kb-rows-text-ellipsis%})

* [Row Selection in Edit with InCell EditMode]({%slug grid-kb-row-select-incell-edit%})

* [ForeignKey column]({%slug grids-foreign-key%})

* [Static Group in Grid]({%slug grid-kb-static-group%})

* [Multi-level Hierarchy]({%slug grid-three-level-hierarchy%})

* [Virtual Scrolling Does Not Work]({%slug grid-kb-virtual-scrolling-troubleshooting%})
