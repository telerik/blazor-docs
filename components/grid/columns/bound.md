...
* `EditorType` - set the [editor component for `string` or `DateTime` columns](slug:components/grid/editing/overview#column-editors) when an [`EditorTemplate`](slug:grid-templates-editor) is not used.
