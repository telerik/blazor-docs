...
This example shows how you can use the various data annotation attributes to set the column titles, make fields non-editable, select the order of the columns and to set en explicit width to the autogenerated columns.
