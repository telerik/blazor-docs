 ...
 * The properties with attribute `[Display(AutoGenerateField=false)]` are not editable.
...
* Use data annotation attributes to set the column titles and make field non-editable
