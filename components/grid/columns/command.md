...
* `Delete` - initiates the [deletion of an existing item](slug:components/grid/editing/overview#delete-operations).
...
> All commands, except `Delete` require [enabled editing](slug:components/grid/editing/overview).
