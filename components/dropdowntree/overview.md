...
1. [Bind the `Value` parameter](slug:common-features-data-binding-overview#data-binding-vs-value-binding) to a variable of the same type as the `ValueField` property.
