...
The Column Chart is similar to the [Range Column Chart]({%slug components/chart/types/rangecolumn%}). The latter allows the column's low end to start above the horizontal axis.
