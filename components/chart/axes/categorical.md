...
page_title: Chart - Categorical Axis
description: Use Categorical Axis in the Chart for Blazor.
slug: chart-axes-categorical
tags: telerik,blazor,chart,categorical,axis
published: true
position: 1
---
...
This article explains how to setup the categorical axis, which Chart types support it, and how to customize its look and feel. You can also add [Plot Bands]({%slug chart-plot-bands%}) to the axis.

## Chart Types That Support Categorical Axis

You can add a Categorical Axis to the Area, Bar, Candlestick, Column, Line, OHLC, Radar, Radar Column, and Radar Line Chart Types. 

## Add A Categorical Axis To Your Chart
