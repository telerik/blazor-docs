...
1. [Bind the component `Value`](slug:common-features-data-binding-overview#data-binding-vs-value-binding) to a variable of the same type as the one of the `ValueField`.
