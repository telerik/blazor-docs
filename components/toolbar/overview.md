...
| ----------- | ----------- | ----------- |
| `Adaptive ` | `bool` | Toggles the overflow popup of the toolbar. Visualizes an additional anchor on the right of the toolbar where it places all items which overflow from the toolbar. |
