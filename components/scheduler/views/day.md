...
You can configure the Day view to display events that are [grouped]({%slug scheduler-grouping%}) by a resource.
...
@* The example showcases Resource Grouping by one resource in a Day view. *@
