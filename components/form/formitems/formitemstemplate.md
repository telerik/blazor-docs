...
1. **Version 4.1.0** added the ability to combine autogenerated and declared Form items. The feature required changes in the Form component implementation. As a result, any custom markup and components inside `<FormItems>` caused unexpected Form item reodering.
...
* `<FormItems>` defines the **configuration** of all Form groups and items.
...
The code snippets below compare the working implementations in versions 4.0.1 and 4.2.0. **Version 4.1.0 does not support the discussed scenario.**
...
&lt;TelerikForm&gt;
    &lt;FormItems&gt;
        <strong>&lt;div&gt;
            ...
            &lt;FormItem Field="PropertyName1" /&gt;
        <strong>&lt;/div&gt;</strong>
        <strong>&lt;div&gt;content between form items&lt;div&gt;</strong>
        &lt;FormItem Field="PropertyName2"&gt;
            &lt;Template&gt;
                ...
            &lt;/Template&gt;
        &lt;/FormItem&gt;
        ...
        <strong>&lt;div&gt;
            ...
            &lt;TelerikFormItemRenderer
                Item="@( formItems.First(x =&gt;
                    x.Field == "PropertyName1") )" /&gt;
        <strong>&lt;/div&gt;</strong>
        <strong>&lt;div&gt;content between form items&lt;div&gt;</strong>
        &lt;TelerikFormItemRenderer
            Item="@( formItems.First(x =&gt;
                x.Field == "PropertyName2") )" /&gt;
    &lt;/FormItemsTemplate&gt;
&lt;/TelerikForm&gt;
...
<TelerikForm Model="@Employee"
    ...
    <FormItems>
        ...
        <FormItem Field="@nameof(Person.BirthDate)" LabelText="Date of Birth" Hint="Enter your Date of Birth"></FormItem>
    </FormItems>
    <FormItemsTemplate Context="formContext">
