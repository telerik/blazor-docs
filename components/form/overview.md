...
* Combining the first two ways - [manually defined and autogenerated form fields together]({%slug form-formitems%}#hybrid-form---combination-of-manually-defined-and-autogenerated-fields).
