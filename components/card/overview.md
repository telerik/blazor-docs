...
| ----------- | ----------- | -------|
| `Class` | `string` | The CSS class that will be rendered on the main wrapping element of the Card. Use it to [apply custom styles, for example, theme colors](slug:card-kb-replace-themecolor-parameter). |
