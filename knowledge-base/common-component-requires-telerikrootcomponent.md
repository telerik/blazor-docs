...
* [Add a `TelerikRootComponent` to one or more layout files](slug:getting-started-workflow-details#telerikrootcomponent), depending on the application's layout structure.
...
* [Typical Usage of the `TelerikRootComponent`](slug:getting-started-workflow-details#telerikrootcomponent)
