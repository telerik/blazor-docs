...
1. [Add the Telerik components as usual](slug:getting-started-workflow-details). Add the [`TelerikRootComponent`](slug:rootcomponent-overview) around the contents of every Blazor component. Otherwise, it is not possible to render it in a shared location like in an actual Blazor app.
