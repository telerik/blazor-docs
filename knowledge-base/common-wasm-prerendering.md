...
You can see how to add Telerik assets, services and the root component in the [What You Need](slug:getting-started-workflow-details) article. Make sure you are familiar with it before you continue reading. Both the client-side, and the server-side information is necessary.
