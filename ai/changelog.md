---
title: Changelog
meta_title: Telerik Blazor AI Tools Changelog
...
* Added an Accessibility Assistant to the Telerik Blazor MCP server to provide WCAG 2.2 Level AA guidance, help implement proper ARIA roles, and surface component-specific accessibility API references.
