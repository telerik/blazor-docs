...
page_title: On-Premises Deployment - Telerik UI for Blazor Agentic UI Generator
description: Learn how to deploy the Telerik UI for Blazor Agentic UI Generator Context API stack on-premises using the provided Helm chart in your Kubernetes cluster.
slug: agentic-ui-generator-on-premises
position: 15
tag: new
published: True
---
...
The Telerik UI for Blazor Agentic UI Generator supports on-premises deployment through a Helm chart that installs the Context API stack into your Kubernetes cluster. The deployment includes the Context API service, a bundled reranking service, and [Qdrant](https://qdrant.tech/) for vector storage.
