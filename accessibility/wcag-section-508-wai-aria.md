...
> The described level of compliance in the table below is achievable with the [**Ocean Blue Sass Swatch**]({%slug accessibility-overview%}#color-contrast) and the **Default Ocean Blue A11Y**.
